<template>
    <div class="mx-auto p-4" style="max-width: 350px;">
      <div class="mb-4">
        <img 
          src="https://yvqzjxlqxmvqtjqgvxqg.supabase.co/storage/v1/object/public/images/dashboard-header.jpg"
      ...
      <div class="space-y-4">
        ...
        <div class="bg-white shadow rounded-lg p-4">
            ...
            <div v-for="(status, network) in networkStatus.value" :key="network" class="flex items-center justify-between mb-2">
                <span class="capitalize text-sm">{{ network }}</span>
                <circle-icon :style="{ color: status }" class="h-4 w-4" />
